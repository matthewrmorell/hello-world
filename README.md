...
<div class="container">
    ...
    <h3 id="cocktails">Signature Cocktails</h3>
    ...
    <div class="col-sm-12 col-md-6 col-lg-6">
        <div class="well">
            <h3 id="beer">Red Wine</h3>
                ...
                <p>Paul Dolan Pinot Noir &emsp; 8/36</p>
    ...
    <div class="col-sm-12 col-md-6 col-lg-6">
        <div class="well"><h3 id="beer">Draft Beer</h3>
            ...
            <p>Rhinegeist Bubbles &emsp; 3.5/7</p>
...
<div class="section-support" id="farms">
    <div class="row">
        <h4 id="support">Suppliers</h4>
    </div>
        <div class="row js--wp-3">
        <div class="col span-1-of-4 box">
            <img src="resources/img/birdfish-logo_black.png" alt="BirdfishBrewingCo">
            <div class="farmtotable-feature">
                <i class="ion-social-instagram icon-small"></i>
                <a href="https://www.instagram.com/birdfishbrew/">Instagram</a><br>
                <i class="icon-small ion-logo-facebook"></i>
                <a href="https://www.facebook.com/birdfishbrew">Facebook</a><br>
            </div>
        </div>
        <div class="col span-1-of-4 box">
            <img src="resources/img/lamppost-logo.png" alt="LamppostFarm">
            <div class="farmtotable-feature">
                <i class="ion-social-instagram icon-small"></i>
                <a href="https://www.instagram.com/explore/locations/127264643/lamppost-farm/">Instagram</a><br>
                <i class="icon-small ion-logo-facebook"></i>
                <a href="https://www.facebook.com/Lamppost-Farm-138000242901403/">Facebook</a>
            </div>
        </div>
        <div class="col span-1-of-4 box">
            <img src="resources/img/whitehouse-logo.png" alt="whitehouse-logo">
            <div class="farmtotable-feature">
                <i class="ion-social-instagram icon-small"></i>
        ...
        <div class="col span-1-of-4 box">
            <img src="resources/img/evergreen-hydroponics_1.png" alt="evergreenHydroponics">
            <div class="farmtotable-feature">
                <i class="ion-social-instagram icon-small"></i>
                <a href="#">Instagram</a><br>
                <i class="icon-small ion-logo-facebook"></i>
...
<script
  ...
  <!-- jQuery (code.jquery.com) needs to come before bootstrap cdn because it is reliant on jQuery -->
